...
public class FhirServerConfig extends RestfulServer {
    ...
    @Autowired
    public FhirServerConfig(PatientProvider patientProvider, EncounterProvider encounterProvider, FhirContext fhirContext) {
    ...
    protected void initialize() throws ServletException {
        ...
        setResourceProviders(Arrays.asList(patientProvider, encounterProvider));
